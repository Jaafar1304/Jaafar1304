...
## 🎯 Ce que je fais
- Analyse et gestion de données en santé publique (routine, enquêtes, recherche)
- Appui à l’élaboration de protocoles, plans stratégiques et cadres de performance
- Modélisation statistique / ML pour l’aide à la décision (ex. malnutrition, mortalité, etc.)
...
**Stats / Data :** R, Stata, SPSS, Epi Info  
**SIG :** QGIS, AccessMod  
**Gestion / rédaction :** MS Project, EndNote/Zotero, Word/Excel/PowerPoint  
**Bio / labo :** PCR, génotypage, séquençage (selon projets)
...
## 📫 Me contacter
- Email : aboubacrdra@outlook.fr
- LinkedIn : https://www.linkedin.com/feed/?trk=guest_homepage-basic_google-one-tap-submit
- Google Scholar / ORCID : https://orcid.org/0009-0005-8983-5542

<!--
**Jaafar1304/Jaafar1304** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
